	...
	static int ManejarLinea(string texto, int numeroSalto)
{
	...
	static void Main()
	{
		...
		saltos[2] = 8; // si el usuario responde "2", salta a la posición 5
		...
		saltos[5] = 12; // si el usuario responde "2", salta a la posición 6
		
		textos[6] = "Mientras comes ves que aun puedes llegar.";
		saltos[6] = 0;
		
		textos[7] = "1) Irse a casa. 2) Seguir mientras comes en el camino.";
		saltos[7] = 14; // si el usuario responde "2", salta a la posición 10
		
		textos[8] = "Entras por el atajo. Al fondo hay una construcción bloqueando el paso.";
		saltos[8] = 0;
		
		textos[9] = "Llegas a clase justo a tiempo. FINAL: LLEGASTE.";
		saltos[9] = 1; // esta línea es un final: el programa debe terminar aquí
		...
		saltos[11] = 12; // si el usuario responde "2", salta a la posición 12
